...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__markerStyles_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__submissions_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__existingXFits_js__ = __webpack_require__(1);
...
$( document ).ready(function() {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_0__setup_js__["a" /* setUp */])();
  Object(__WEBPACK_IMPORTED_MODULE_2__submissions_js__["a" /* submitXfit */])();

  $('#showXfits').click(function() {
    console.log(XFitID);
    if (XFitID > -1){
      console.log(__WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap._layers[XFitID]);
      __WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap._layers[XFitID].removeLayer( );
    }
    else{
      XFitID = Object(__WEBPACK_IMPORTED_MODULE_3__existingXFits_js__["a" /* showCurXfits */])();
    }
  });
...
"use strict";
/* unused harmony export XFitMakersID */
/* harmony export (immutable) */ __webpack_exports__["a"] = showCurXfits;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__setup_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__markerStyles_js__ = __webpack_require__(4);
...
function showCurXfits(){
    console.log(__WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap._layers[29])



    if(__WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap._layers[29]){
      console.log(__WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap._layers[29].layer)
      var  layer = __WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap._layers[29];
      __WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap.removeLayer(layer);
    }
    else {
      var allMarkers;
        ...
        {showCoverageOnHover: true,
         ...
         iconCreateFunction: function (cluster) {
           ...
           for (let i = 0; i < allMarkers.length; i++) {
             allMarkers[i].setIcon(__WEBPACK_IMPORTED_MODULE_1__markerStyles_js__["a" /* icons */].existingXFits);
           }
      ...
      $.getJSON("https://"+cartoDBUserName+".carto.com/api/v2/sql?format=GeoJSON&q="+sqlQuery, function(data) {
          ...
          existingXFits = L.geoJson(data,{
              pointToLayer: function(feature, latlng){
                 return L.marker(latlng, {icon: __WEBPACK_IMPORTED_MODULE_1__markerStyles_js__["a" /* icons */].existingXFits});
              } ,
          ...
          for (var i = 0; i < markers.length; i++) {
            markers[i].setIcon(__WEBPACK_IMPORTED_MODULE_1__markerStyles_js__["a" /* icons */].existingXFits);
          }
        ...
        //  markers.setIcon(XFitIcon);
          __WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap.addLayer(markers);
...
"use strict";
/* unused harmony export newAddition */
/* harmony export (immutable) */ __webpack_exports__["a"] = submitXfit;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__setup_js__ = __webpack_require__(3);
...
function submitXfit( ){
  ...
  //add to map
  __WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap.addLayer(drawnItems);
  ...
  //add controls
  __WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap.addControl(drawControl);
  ...
  __WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap.on('draw:created', function (e) {
    ...
    if (type === 'marker') {
      ...
      __WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap.addLayer(layer);
      ...
      popupLayer.openOn(__WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap);
    ...
    reviewComplete(
      ...
      __WEBPACK_IMPORTED_MODULE_0__setup_js__["b" /* setUpVars */].mymap.closePopup();
    });
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return setUpVars; });
